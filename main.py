...
def run_single(
    ...
    print(f"Pauli set: {'Pi(NC) non-commuting' if use_noncommuting else 'Pi(C) k-body'}")
...
def main():
    ...
    parser.add_argument('--tabu', action='store_true',
                        help="Enable tabu search refinement")
    parser.add_argument('--tabu-iters', type=int, default=5000,
                        help="Max tabu search iterations")
